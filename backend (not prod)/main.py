...
This is a COPY of the backend code for StudySphere since the real backend is in a separate git repo.

This FastAPI backend provides a 3-stage generation process for creating educational mind maps:
1. Generate Structure: Creates a hierarchical mind map structure based on a given topic.
2. Generate Content: Produces educational content for each node in the mind map.
3. Generate Quizzes: Develops comprehension quizzes for each node to test understanding.
